...
//			Boxhead.printf(y);
		...
		public void drawText(SpriteBatch batch){
			small.draw(batch, this.text, this.button.x - small.getBounds(this.text).width/2, this.button.y + small.getBounds(this.text).height/2 + 70);
		}

		public void draw (ShapeRenderer sr){
			if (selected){
				sr.begin(ShapeType.FilledCircle);
				sr.setColor(17, 183, 229, 143);
				sr.filledCircle(this.button.x, 720-this.button.y, this.button.radius-5);
				sr.end();
			}
